...
## Exercises: Minimizing Work with Functions
 ...
 - sequence of exercises:
    * create a function like miles to km or km to miles
    * add arguments to let the user decide which units to convert
    * add roxygen documentation
    * apply the function to a list of distances from Santa Barbara and report as a dataframe