...
## Exercises: Minimizing Work with Functions
...
* $a$ should be between 0 and 1 (usually very small); $b$ should be greater than 1.
...
#' @param a The `a` value for the formula; default 0.00057 for Chinook 
#'          salmon length given in inches
...
<!-- end exercise:  documentation -->
 ...
 - sequence of exercises:
    * create a function like miles to km or km to miles, or fish weight from length using W = aL^b
    * add arguments (with defaults) to let the user specify a, b, and whether length is in inches or cm (and then convert accordingly)
    * add roxygen documentation
    * apply the function to a list of fish lengths
    * optional - plot with a custom theme
