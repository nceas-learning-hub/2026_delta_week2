...
Make sure you’re in the right project (`training_<username>`). Use Git Pull to check for any changes. Then, create a new Quarto document and save it as **`data-visualization.qmd`**.
