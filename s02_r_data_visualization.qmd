...
## Wrong! Set `fill` to a specific color *inside* `aes()`
...
### 3.2 Ordering bars and adding color
...
`ggsave()` automatically saves the last plot displayed, or pass `plot = my_object` to save a specific one.
