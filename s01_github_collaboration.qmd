...
![Artwork by @allison_horst](images/github_collaboration/allison_horst_jenny_bryan_quote.png){width="100%" fig-align="center" .lightbox}
...
3. [**Collaborator**]{style="color: purple;"} edits, commit-pull-push
...
4. [**Owner**]{style="color: orange;"} pulls, edits, commit-pull-push{.unnumbered}
    ...
    * The [**Owner**]{style="color: orange;"} then makes their own edits as they see fit, following the same **commit {{<fa arrow-right>}} pull {{<fa arrow-right>}} push** workflow. 
...
4. [**Collaborator**]{style="color: purple;"} pushes
    * **GitHub now reflects the [Collaborator]{style="color: purple;"}'s version.** The [**Owner**]{style="color: orange;"} is one commit behind.
5. [**Owner**]{style="color: orange;"} tries to push {{<fa arrow-right>}} gets an error
6. [**Owner**]{style="color: orange;"} pulls {{<fa arrow-right>}} sees merge conflict
7. [**Owner**]{style="color: orange;"} edits the file to resolve the conflict
