...
GenAI tools are/were trained on all publicly-available information (in many cases, regardless of license or copyright status) and on users' ongoing interactions with these tools. Keep in mind that the creators of the original content used to train the models are not currently credited for their work (and are not likely to be credited) and include that in your decision-making process for whether/how to use these tools.
