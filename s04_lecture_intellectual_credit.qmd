...
Parts of the content in this page was adapted from the Long Term Ecological Research (LTER) Network's course "Synthesis Skills for Early Career Researchers" (SSECR). Those materials can be found at [lter.github.io/ssecr](https://lter.github.io/ssecr/){.external target="_blank"}
:::
...
The Ecological Society of America (ESA) created a [Code of Ethics](https://esa.org/about/code-of-ethics/){.external target="_blank"} with some guidance for publication co-authorship as part of it. ESA suggests that reserachers claim authorship only if they have made a "substantial contribution" to the work. 
...
The [Contributor Role Taxonomy](https://credit.niso.org/){.external target="_blank"} (CRediT) separates research roles into [14 categories](https://zenodo.org/records/18421449){.external target="_blank"} though doesn't necessarily identify how performing those duties relates to authorship. Many teams that adopt this framework decide on some critical number of categories that a team member must fulfill in order to warrant authorship.
...
1. [Nutrient Network Authorship Policy](https://nutnet.org/authorship){.external target="_blank"}
2. Expanded Authorship Guidelines[@cooke_ContemporaryAuthorship_2021]
3. CReDiT Framework [@brand_AuthorshipAttribution_2015]
4. [Arctic Data Center (ADC) Template](https://docs.google.com/document/d/16wNpk9vJiWqQQStmaEG66YgawU39hGC8x9KnbUqbyO4/edit#heading=h.gnbwiz3v0o8z){.external target="_blank"}
