...
For teams that adopt this framework, a common convention is to create a shared spreadsheet with one row per collaborator with a column for each of the CRediT roles. Each collaborator simply marks an "X" in each column for which they feel they've contributed. Such a spreadsheet can also be a useful place to aggregate affilitation information as well!
