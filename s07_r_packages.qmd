...
However, most R users have never created a package for their own work, often out of a fear that the process is too complicated. In reality, it's fairly straighforward and super useful in your personal work. Creating packages serves two main use-cases:
...
The `usethis`, `devtools` and `roxygen2` packages make greatly streamline the process of creating and maintining a package.
:::
